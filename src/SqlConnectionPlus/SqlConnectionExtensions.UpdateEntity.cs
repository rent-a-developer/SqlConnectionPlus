...
public static partial class SqlConnectionExtensions
{
    ...
    /// <param name="connection">The SQL connection to use to update the entity.</param>
    ...
    /// </exception>
    /// <remarks>
    /// The table where the entity will be updated is determined by the <see cref="TableAttribute" />
    ...
    /// </code>
    /// </example>
    public static async Task<Int32> UpdateEntityAsync<TEntity>(
        this SqlConnection connection,
        TEntity entity,
        SqlTransaction? transaction = null,
        CancellationToken cancellationToken = default
